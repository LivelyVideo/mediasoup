...
import { ProducerStat, Producer } from './Producer';
import {
	MediaKind,
	RtpCapabilities,
	RtpParameters
...
export type ConsumerOptions<ConsumerAppData extends AppData = AppData> =
	{
		/**
	 * optional pass in a producer object instead of relying
	 * on lookup by producer id (used when shared memory is used)
	 */
		producer?: Producer;
		/**
