...
export type WorkerSettings<WorkerAppData extends AppData = AppData> = {
	...
	/**
	 * Lively-specific: Developer logging level.
	 */
	logDevLevel?: WorkerDevLogLevel;

	/**
	 * Lively-specific: Enable trace logging.
	 */
	...
	/**
	 * Lively-specific: MSWorker log file name.
	 */
	logFile?: string;

	/**
	 * Lively-specific: Disable binary stats logs.
	 */
	binStatsDisabled?: boolean;

	/**
	 * Lively-specific: Binary stats logs path, msworker will add /bin subfolder to it.
	 */
	binStatsPath?: string;
