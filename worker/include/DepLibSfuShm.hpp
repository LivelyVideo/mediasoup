...
namespace DepLibSfuShm
{
  ...
  public:
    ...
    void InitializeShmWriterCtx(std::string clientReferrer, std::string shm, int queueAge, bool useReverse, int testNack, std::string log, int level, std::string shmAppData);
