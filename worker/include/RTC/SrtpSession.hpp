...
namespace RTC
{
	...
	public:
		...
		{
			// srtp_stream_remove is not available in libsrtp2 v2.6.0
			// This functionality may need to be handled differently or is not needed
			(void)ssrc; // Suppress unused parameter warning
		}
