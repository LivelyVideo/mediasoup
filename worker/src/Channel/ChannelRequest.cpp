...
namespace Channel
{
	...
	absl::flat_hash_map<std::string, ChannelRequest::MethodId> ChannelRequest::string2MethodId =
	{
		...
		{ "worker.logopen",                              ChannelRequest::MethodId::WORKER_MSLOG_OPEN                                },
		{ "worker.logrotate",                            ChannelRequest::MethodId::WORKER_MSLOG_ROTATE                              },
		...
		{ "router.createShmTransport",                   ChannelRequest::MethodId::ROUTER_CREATE_SHM_TRANSPORT                      },
